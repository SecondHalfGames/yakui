...
/// We make a text widget here that has clipping enabled so we can test more clip resolution behaviours.
#[derive(Debug)]
...
impl TooltipLabel {
    ...
    pub fn show(self) -> Response<()> {
        widget::<TooltipLabelWidget>(self)
    }
}

#[derive(Debug)]
pub struct TooltipLabelWidget {}

impl Widget for TooltipLabelWidget {
    type Props<'a> = TooltipLabel;
