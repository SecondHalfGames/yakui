...
use crate::widgets::{
    ...
    FlexibleWidget, Image, ImageWidget, List, ListWidget, Ninepatch, NinepatchWidget, Offset,
...
) -> Response<NinepatchWidget> {
    Ninepatch::new(texture, margins, scale).show(children)
}
