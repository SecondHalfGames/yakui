...
pub struct FontSelection {
    ...
    serif_family: Cow<'static, str>,
    sans_serif_family: Cow<'static, str>,
    cursive_family: Cow<'static, str>,
    fantasy_family: Cow<'static, str>,
    monospace_family: Cow<'static, str>,
}
...
impl FontSelection {
    ...
    pub fn set_serif_family<S: Into<Cow<'static, str>>>(&mut self, family: S) {
        self.serif_family = family.into();
    }

    pub fn set_sans_serif_family<S: Into<Cow<'static, str>>>(&mut self, family: S) {
        self.sans_serif_family = family.into();
    }

    pub fn set_cursive_family<S: Into<Cow<'static, str>>>(&mut self, family: S) {
        self.cursive_family = family.into();
    }

    pub fn set_fantasy_family<S: Into<Cow<'static, str>>>(&mut self, family: S) {
        self.fantasy_family = family.into();
    }

    pub fn set_monospace_family<S: Into<Cow<'static, str>>>(&mut self, family: S) {
        self.monospace_family = family.into();
    }
